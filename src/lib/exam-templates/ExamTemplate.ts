...
import { SelfAssessmentConfig } from "@/models/Exam";
...
export const EXAM_TEMPLATES: ExamTemplate[] = [
  // ========== ÉVALUATIONS DIAGNOSTIQUES ==========
  {
    ...
    description:
      "Évaluer le niveau initial des élèves avant de commencer un nouveau chapitre",
    category: "DIAGNOSTIC",
    defaultConfig: {
  ...
  // ========== ÉVALUATIONS FORMATIVES ==========
  {
    ...
    description:
      "L'élève évalue sa maîtrise de chaque concept sur une échelle à 7 niveaux",
    category: "FORMATIVE",
    defaultConfig: {
      evaluationType: EvaluationType.QCM,
...

  {
    ...
    name: "Quiz formatif",
    description:
      "Quiz d'entraînement avec feedback immédiat pour l'apprentissage",
    category: "FORMATIVE",
    defaultConfig: {
      evaluationType: EvaluationType.QCM,
...

  {
    ...
    name: "Examen final",
    description: "Examen final couvrant tout le Syllabus",
    category: "SUMMATIVE",
    defaultConfig: {
      evaluationType: EvaluationType.MIXED,
      pedagogicalObjective: PedagogicalObjective.SUMMATIVE_EVAL,
  ...
  // ========== COMPÉTITIONS ==========
  {
    ...
    description:
      "Challenge compétitif entre classes avec classement temps réel",
 ...
 */
export function getTemplateByExamType(
  examType: ExamType,
