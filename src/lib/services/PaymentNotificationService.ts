...
export class PaymentNotificationService {
   ...
   */
  private static async sendPaymentEmail(
   ...
   */
  private static getSuccessEmailHtml(
    transaction: ITransaction,
    userName: string,
  ): string {
    const typeLabel = this.getTypeLabel(transaction.type);
...
<body>
    <div class="container">
        ...
        <div class="footer">
            <p>Xkorienta - Votre plateforme d'apprentissage</p>
        </div>
    </div>
</body>
</html>`;
   ...
   */
  private static getFailureEmailHtml(
    transaction: ITransaction,
    userName: string,
  ): string {
    const typeLabel = this.getTypeLabel(transaction.type);
