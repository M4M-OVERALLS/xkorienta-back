...
export class ExamBuilder {
    ...
    setType(examType: ExamType): this {
        ...
        this.exam.pedagogicalObjective = template.defaultConfig.pedagogicalObjective
...
async function createExam() {
    ...
    await builder.setTarget({
        ...
        syllabusId: '507f191e810c19729de860ec', // Programme Tle C
    ...
    return (
        <WizardContainer>
            ...
            {React.createElement(steps[currentStep].component, {
                examId,
                onComplete: (data) =>
                    handleStepComplete(steps[currentStep].id, data)
            })}
        </WizardContainer>
    )
}
