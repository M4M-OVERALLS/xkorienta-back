 ...
 * 
 * Creates the default plans for the QuizLock platform:
...
const DEFAULT_PLANS = [
    {
        code: 'FREEMIUM',
        name: 'Gratuit',
        description: 'Accès de base à la plateforme QuizLock. Parfait pour découvrir nos services.',
        prices: [],
        features: [
    ...
    },
    {
        ...
        description: 'Abonnement mensuel avec accès complet à toutes les fonctionnalités premium.',
        prices: [
            ...
            { currency: Currency.USD, amount: 9, interval: SubscriptionInterval.MONTHLY }
        ],
        features: [
    ...
    },
    {
        code: 'PREMIUM_YEARLY',
        name: 'Premium Annuel',
        description: 'Abonnement annuel avec 2 mois gratuits. Le meilleur rapport qualité-prix!',
        prices: [
            { currency: Currency.XAF, amount: 50000, interval: SubscriptionInterval.YEARLY }, // 2 mois gratuits
            { currency: Currency.EUR, amount: 80, interval: SubscriptionInterval.YEARLY },
            { currency: Currency.USD, amount: 90, interval: SubscriptionInterval.YEARLY }
        ],
        features: [
    ...
    },
    {
        code: 'INSTITUTION',
        name: 'Institution',
        description: 'Forfait pour les écoles et établissements. Contactez-nous pour un devis personnalisé.',
        prices: [
            { currency: Currency.XAF, amount: 500000, interval: SubscriptionInterval.YEARLY },
            { currency: Currency.EUR, amount: 800, interval: SubscriptionInterval.YEARLY },
            { currency: Currency.USD, amount: 900, interval: SubscriptionInterval.YEARLY }
        ],
        features: [
...
async function main() {
    console.log('═══════════════════════════════════════════')
    console.log(' QuizLock - Subscription Plans Seed')
    console.log('═══════════════════════════════════════════')
